...
const PROJECTS = [
  {
    id: 1, title: "AI Accessibility Assistant", emoji: "♿", color: "#7c3aed",
    description: "AI-powered tool for real-time digital accessibility using computer vision and NLP.",
    tech: ["Python", "OpenAI", "React", "FastAPI"],
    github: "https://github.com/Khushbu-github", live: "#",
  },
  {
    id: 2, title: "Mama Bot – Parenting Advisor", emoji: "👶", color: "#0ea5e9",
    description: "Evidence-based parenting chatbot with milestone tracking and expert guidance.",
    tech: ["Python", "NLP", "Dialogflow", "Firebase"],
    github: "https://github.com/Khushbu-github", live: "#",
  },
  {
    id: 3, title: "Planova – Project Management", emoji: "📋", color: "#10b981",
    description: "Student-teacher collaboration platform with task tracking and analytics.",
    tech: ["React", "Node.js", "MongoDB", "Express"],
    github: "https://github.com/Khushbu-github", live: "#",
  },
  {
    id: 4, title: "Hospital Management Platform", emoji: "🏥", color: "#f59e0b",
    description: "Full-stack system for patient records, appointments and staff coordination.",
